...
class CadastrarModeloViewTests(TestCase):
    ...
    def test_cadastrar_modelo_view_post(self):
        ...
        response = self.client.post(reverse("modelo:cadastrar_modelo"), data)
    ...
    def test_cadastrar_modelo_view_get(self):
        ...
        response = self.client.get(reverse("modelo:cadastrar_modelo"))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, "cadastrar_modelo.html") # Corrigido: sem 'modelo/' prefixo
